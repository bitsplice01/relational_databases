...
--
-- Name: elements elements_name_not_null; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT elements_name_not_null UNIQUE (name);
...
--
-- Name: elements elements_symbol_not_null; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT elements_symbol_not_null UNIQUE (symbol);
...
--
-- Name: properties properties_elements_atomic_number_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT properties_elements_atomic_number_fk FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);


--
-- Name: properties properties_types_type_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT properties_types_type_id_fk FOREIGN KEY (type_id) REFERENCES public.types(type_id);
